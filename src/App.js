  ...
  return (
    <div className="App">
      ...
      <h2><code>8 WEEK MEAL PLAN - FOCUS ON HITTING IT 80%</code></h2>
        <img src={require('./meal1.png')} width="500" alt="" />
        ...
        <img src={require('./meal2.png')} width="500" alt="" />
        ...
        <img src={require('./meal3.png')} width="500" alt="" />
