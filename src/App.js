  ...
  return (
    <div className="App">
      ...
      <h2><code>8 WEEK MEAL PLAN - FOCUS ON HITTING IT 80%</code></h2>
        <img src={require('./meal1.png')} style={{ width: '175px'}} alt="" />
        ...
        <img src={require('./meal2.png')} style={{ width: '175px'}} alt="" />
        ...
        <img src={require('./meal3.png')} style={{ width: '175px'}} alt="" />
...
<p>-You can use any sauce / spices. Load up on the mutivitamin and B-vitamins-</p>
    ...
    <img src={require('./push.png')} style={{ width: '175px'}} alt="" />
    <h4>Day 2: Pull 1 - Back focused Day</h4>
    <img src={require('./pull.png')} style={{ width: '175px'}} alt="" />
    <h4>Day 3: Lower Body -Quad focused Day</h4>
    <img src={require('./lb1.png')} style={{ width: '175px'}} alt="" />
    <h3><u><code>Day 4: REST DAY</code></u></h3>
    <h4>Day 5: Lower Body -Glute & Hamstring focused Day</h4>
    <img src={require('./lb2.png')} style={{ width: '175px'}} alt="" />
    <h4>Day 6: Supplementary / conditioning maintenence</h4>
    <img src={require('./supp.png')} style={{ width: '175px'}} alt="" />
